...
=end
  ...
  test "parses hashtags and links them" do
    ...
    assert_equal "<p data-sourcepos=\"1:1-1:13\"><a href=\"/test/timeline/search?query=%23foo\">#foo</a> bar<a href=\"/test/timeline/search?query=+%23baz\"> #baz</a></p>", hashtag_markdown_html
  end
  ...
  test "parses contacts and links them" do
    ...
    # .user_mention class
    assert_equal "<p data-sourcepos=\"1:1-1:13\"><a href=\"/test/timeline/search?query=%40foo\" class=\"user-mention\">@foo</a> bar <a href=\"/test/timeline/search?query=%40baz\" class=\"user-mention\">@baz</a></p>", contact_markdown_html
  end
